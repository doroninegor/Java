...
public class Task5 {
    public static void main(String[] args) {
        System.out.println(exe1.encrypt("Sunshine"));
        System.out.println(exe1.decrypt( new int[]{83, 34, -7, 5, -11, 1, 5, -9}));
        System.out.println(exe2.canMove("Rook", "A8", "H8"));
        System.out.println(exe3.canComplete("bauul", "beautiful"));
        System.out.println(exe4.sumDigProd(16, 28));
        System.out.println(exe5.sameVowelGroup("hoops", "chuff", "bot", "bottom"));
        System.out.println(exe6.validateCard(new BigInteger("1234567890123452")));
        System.out.println(exe7.numToEng(18));
        System.out.println(exe8.getSha256Hash("password123"));
        System.out.println(exe9.correctTitle("jOn SnoW, kINg IN thE noRth."));
        exe10.hexLattice(19);
