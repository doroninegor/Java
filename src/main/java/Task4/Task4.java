...
class Task4 {
    public static void main(String[] args) {
        exe1.bessie(10, 7, "hello my name is Bessie and this is my essay");
        System.out.println();
        System.out.println(exe2.split("((()))(())()()(()())"));
       System.out.println(exe3.toCamelCase("is_modal_open"));
        System.out.println(exe3.toSnakeCase("helloEdabit"));
        System.out.println(exe4.overTime(9, 17, 30, 1.5));
        exe5.BMI("154 pounds", "2 meters");
       System.out.println();
        System.out.println(exe6.bugger(999));
        System.out.println(exe7.toStarShorthand("abbccc"));
       System.out.println(exe8.doesRhyme("Sam I am!", "Green eggs and HAM."));
        System.out.println(exe9.trouble(451999277, 411777299));
        System.out.println(exe10.countUniqueBooks("AZYWABBCATTTA", 'A'));
    }
}
class exe1 {
